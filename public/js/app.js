...
/***/ function(module, exports) {
	...
	angular.module('app.components', ['ui.router', 'angular-loading-bar', 'restangular', 'ngStorage', 'satellizer', 'ui.bootstrap', 'chart.js', 'mm.acl', 'datatables', 'datatables.bootstrap', 'checklist-model', 'ngGeolocation', 'geolocation', 'ngMap']);
...
/***/ function(module, exports) {
	...
	var DashboardController = function DashboardController($scope, $geolocation, geolocation, $http) {
	  'ngInject';
	...
	DashboardController.$inject = ["$scope", "$geolocation", "geolocation", "$http"];
