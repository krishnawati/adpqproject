...
/***/ function(module, exports) {
	...
	angular.module('app.components', ['ui.router', 'angular-loading-bar', 'restangular', 'ngStorage', 'satellizer', 'ui.bootstrap', 'chart.js', 'mm.acl', 'datatables', 'datatables.bootstrap', 'checklist-model', 'geolocation', 'ngGeolocation', 'ngMap']);
...
/***/ function(module, exports) {
	...
	var DashboardController = function () {
	  DashboardController.$inject = ["$scope", "$geolocation", "geolocation", "$http", "API"];
	  function DashboardController($scope, $geolocation, geolocation, $http, API) {
	    'ngInject';
	    ...
	    $scope.data = {
	      model: null,
	      availableOptions: [{ id: '1', name: '25' }, { id: '2', name: '50' }, { id: '3', name: '100' }]
	    };
	    $scope.data2 = {
	      model: null,
	      factors: [{ id: '1', name: 'earthquake' }]
	    };
	  ...
	  _createClass(DashboardController, [{
	    ...
	    value: function submit() {
	      ...
	      console.log("1st");
	      this.API.all('postxr').post(data).then(function (response) {
	        console.log(response);
	      });
	    }
	  }]);
